...
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "center.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "centre.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "color.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "colour.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "ise.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "ize.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "labeled.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "labelled.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "yse.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "yze.dic" ) ) );
//      dictionary.addDictionary( new InputStreamReader( SpellCheckerUtil.class.getResourceAsStream( "ou_words.dic" ) ) );
    }
    catch( IOException e )
    {
  ...
  public static boolean isWordCorrect( String word, boolean startsSentence )
  {
    ...
    if( !correct )
    {
      ...
      if( (getConfig().getBoolean( Configuration.SPELL_IGNOREMIXEDCASE ) && isMixedCaseWord( word, startsSentence )) || (getConfig().getBoolean( Configuration.SPELL_IGNOREUPPERCASE ) && isUpperCaseWord( word )) || (getConfig().getBoolean( Configuration.SPELL_IGNOREDIGITWORDS ) && isDigitWord( word )) || (getConfig().getBoolean( Configuration.SPELL_IGNOREINTERNETADDRESSES ) && isINETWord( word )) )
      {
        return true;
      }
    }
   ...
   */
  public final static boolean isMixedCaseWord( String word, boolean startsSentence )
  {
